...
import instock.lib.database_sqlite as mdb
...
import instock.web.newsHandler as newsHandler
...
class Application(tornado.web.Application):
    def __init__(self):
        handlers = [
            ...
            (r"/instock/news", newsHandler.GetNewsHandler),
        ]
        settings = dict(  # 配置
        ...
        # self.db = torndb.Connection(**mdb.MYSQL_CONN_TORNDB)  # SQLite mode: disabled
